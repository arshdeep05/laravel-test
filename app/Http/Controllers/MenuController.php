...
class MenuController extends BaseController
{
     ...
     */
    private function getChildMenuItem( $originalArray, $id ){
        ...
        if( $menuItems ){
            ...
            forEach( $menuItems as $key => $val ){  
                ...
                $originalArray['children'][] = $this->getChildMenuItem( $val ,$val['id']);
    ...
    public function getMenuItems() {
        ...
        if( $menuItems && $menuItems->count() > 0){
            ...
            forEach( $menuItems as $key => $val ){
                ...
                $menuArr[] = $this->getChildMenuItem( $val ,$val['id']);

               
            }
            return response()->json($menuArr,200);
        }
    }
}
